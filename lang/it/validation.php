...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Il campo :attribute è apparso in una violazione di dati. Scegli un valore diverso.',
    ],
    ...
    */
    ...
    'custom' => [
        'vat_number' => [
            'regex' => 'La partita IVA deve contenere esattamente 11 cifre.',
        ],
        'tax_code' => [
            'size' => 'Il codice fiscale deve contenere esattamente 16 caratteri.',
            'regex' => 'Il formato del codice fiscale non è valido.',
        ],
        'end_date' => [
            'after' => 'La data fine deve essere successiva alla data inizio.',
        ],
    ],
